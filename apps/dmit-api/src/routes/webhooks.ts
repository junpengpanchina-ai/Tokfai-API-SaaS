...
webhookRoutes.post("/stripe/webhook", handleStripeWebhook);

// Compatibility alias for the earlier route shape.
webhookRoutes.post("/v1/webhooks/stripe", handleStripeWebhook);
