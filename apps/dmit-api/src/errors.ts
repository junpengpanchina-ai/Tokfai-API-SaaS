...
export const STATUS_BY_ERROR_CODE: Record<string, number> = {
  ...
  tool_intent_not_generated: 502,
  tool_intent_invalid_json: 502,
  tool_name_not_allowed: 502,
  tool_arguments_invalid: 502,
  required_tool_call_missing: 502,
  tool_intent_too_large: 502,
  tool_emulation_unavailable: 400,
  quota_exceeded: 429,
