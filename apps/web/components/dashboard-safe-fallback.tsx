...
export function DashboardSafeFallback({
  page,
  copiedId,
  onCopy,
}: {
  page: DashboardSafePageId;
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Use API Keys to create a key, copy the one-line curl, and reconcile in Usage and Credits.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Copy a one-line curl and test your API key.</CardDescription>
        </CardHeader>
