...
export const PUBLIC_MODEL_REGISTRY: PublicModel[] = [
  ...
  {
    id: "gpt-5.6-sol",
    displayName: { zh: "GPT 5.6 Sol", en: "GPT 5.6 Sol" },
    family: "gpt",
    status: "public",
    visible: true,
    group: "chat",
    ...
    tags: ["recommended", "best_quality"],
    descriptionZh: "GPT 5.6 Sol 对话与推理模型，适合文本与代码任务。",
    descriptionEn: "GPT 5.6 Sol chat and reasoning model for text and coding tasks.",
    bestForZh: "对话、推理与代码",
    bestForEn: "Chat, reasoning, and coding",
  },
  {
    id: "gpt-5.6-terra",
    displayName: { zh: "GPT 5.6 Terra", en: "GPT 5.6 Terra" },
    family: "gpt",
    status: "public",
    visible: true,
    group: "chat",
    ...
    beginnerFriendly: false,
    tags: ["recommended", "best_quality"],
    descriptionZh: "GPT 5.6 Terra 对话与推理模型，适合文本与代码任务。",
    descriptionEn: "GPT 5.6 Terra chat and reasoning model for text and coding tasks.",
    bestForZh: "对话、推理与代码",
    bestForEn: "Chat, reasoning, and coding",
  },
  ...
  // —— Compatibility aliases (API-compatible; hidden from /dashboard/models cards) ——
  {
    id: "auto-fast",
