  ...
  en: {
    ...
    admin: {
      ...
      credits: {
        ...
        rechargePlansDesc:
          "Reference recharge tiers for operations planning. Checkout and ledger writes stay on the existing billing flow.",
        stripeSourceOfTruth:
  ...
  zh: {
    ...
    admin: {
      ...
      credits: {
        ...
        rechargePlansDesc:
          "运营规划用的参考充值档位。Checkout 与账本写入仍走现有 billing 流程。",
