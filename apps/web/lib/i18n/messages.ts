  ...
  zh: {
    ...
    dashboard: {
      overview: {
        title: "Overview",
        subtitle:
          "充值算力积分、创建 API Key、阅读接入指南、在 Chat Playground 测试，然后查看 Usage 与 Credits。",
        subtitleReturning:
          "API 已可用。查看用量、管理算力积分，或继续 Playground 测试。",
        continueTitle: "继续使用",
        ...
        creditsConsumedLast7Days: "近 7 天消耗算力积分",
