  ...
  en: {
    ...
    admin: {
      ...
      pricing: {
        ...
        colInput: "input_credits_per_million",
        colOutput: "output_credits_per_million",
        colImage: "image_credits_per_generation",
        colMultiplier: "Multiplier",
        colMinCharge: "Min charge",
        colStatus: "Status",
        colActions: "Actions",
      },
      logs: {
        ...
        filtersTitle: "Search",
        filtersDesc: "Filter by request ID (partial match).",
  ...
  zh: {
    ...
    admin: {
      ...
      logs: {
        ...
        filtersTitle: "搜索",
        filtersDesc: "按 request_id 筛选（部分匹配）。",
        requestIdPlaceholder: "Request ID",
        applyFilter: "应用",
        tableTitle: "错误日志",
        showingCount: "共 {count} 条。",
