  ...
  en: {
    ...
    admin: {
      ...
      pricing: {
        ...
        cancel: "Cancel",
        fieldInputCredits: "Input credits / 1M tokens",
        fieldOutputCredits: "Output credits / 1M tokens",
        fieldImageCredits: "Image credits / generation",
  ...
  zh: {
    ...
    admin: {
      ...
      overview: {
        ...
        totalUsageCredits: "累计消耗积分：{amount}",
      ...
      pricing: {
        ...
        saveFailed: "保存定价失败。",
        cancel: "取消",
        fieldInputCredits: "输入积分 / 百万 tokens",
        fieldOutputCredits: "输出积分 / 百万 tokens",
        fieldImageCredits: "图像积分 / 次",
        fieldMultiplier: "倍率",
        invalidFields: "请检查定价字段后重试。",
        invalidInputCredits: "请输入有效的非负输入积分。",
        invalidOutputCredits: "请输入有效的非负输出积分。",
        invalidImageCredits: "请输入有效的非负图像积分。",
      ...
      users: {
        ...
        userManagement: "用户管理",
        userManagementDesc:
          "浏览邮箱、user_id、积分余额、累计充值与累计消耗。可通过「增加积分 / 扣减积分」进行人工调账。",
        userProfiles: "用户资料",
