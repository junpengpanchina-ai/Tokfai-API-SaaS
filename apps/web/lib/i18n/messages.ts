  ...
  en: {
    ...
    dashboard: {
      ...
      models: {
        ...
        priceDisclaimer:
          "RMB amounts below use 1 yuan ≈ 1,000 credits (1 credit ≈ ¥0.001). Actual charges follow Usage and Credits ledger records.",
        ...
        colApproxRmb: "Approx. RMB",
        chatEstimateShort: "≈ {credits} credits/call ({yuan})",
        chatEstimateLong: "≈ {credits} credits/call ({yuan})",
        chatApproxRmb: "Short {shortYuan} · Long {longYuan}",
        imagePerGeneration: "{credits} credits/image ({yuan})",
        imagePlanGenerations: "{plan} {amount}: ≈ {count} images",
        videoPerUnit: "{credits} credits/unit ({yuan})",
        pricePending: "Price pending",
        packageEstimateTitle: "Package usage estimates",
        packageEstimateDesc:
          "Short chats use {model}; images use {imageModel}. Counts are illustrative.",
        colPackagePlan: "Plan",
        colPackageCredits: "Credits included",
        colPackageShortChats: "Short chat calls",
        colPackageImages: "{credits} credits/image count",
        colPackageImagesFallback: "Image generations",
        packageShortChatCount: "≈ {count} calls",
        packageImageCount: "≈ {count} images",
  ...
  zh: {
    ...
    dashboard: {
      ...
      models: {
        ...
        priceDisclaimer:
          "以下人民币金额按 1 元≈1000 credits（1 credit≈¥0.001）估算，实际扣费以 Usage / Credits 账本为准。",
        ...
        colApproxRmb: "约人民币",
        chatEstimateShort: "约 {credits} credits/次（{yuan}）",
        chatEstimateLong: "约 {credits} credits/次（{yuan}）",
        chatApproxRmb: "短对话 {shortYuan} · 长分析 {longYuan}",
        imagePerGeneration: "{credits} credits/张（{yuan}）",
        imagePlanGenerations: "{plan} {amount}：约 {count} 张",
        videoPerUnit: "{credits} credits/次（{yuan}）",
        pricePending: "价格待公布",
        packageEstimateTitle: "套餐可用量估算",
        packageEstimateDesc:
          "短对话按 {model} 估算；图片按 {imageModel} 估算。以下为示意次数。",
        colPackagePlan: "套餐",
        colPackageCredits: "到账 credits",
        colPackageShortChats: "可用短对话次数",
        colPackageImages: "可生成 {credits} credits 图片数",
        colPackageImagesFallback: "可生成图片数",
        packageShortChatCount: "约 {count} 次",
        packageImageCount: "约 {count} 张",
