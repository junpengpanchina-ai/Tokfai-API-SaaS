  ...
  en: {
    ...
    dashboard: {
      ...
      models: {
        title: "Models",
        subtitle:
          "Browse Tokfai model IDs, credits usage, RMB price examples, and availability. Use these IDs in your API requests or the Chat / Image Playgrounds.",
  ...
  zh: {
    ...
    dashboard: {
      ...
      models: {
        title: "模型",
        subtitle:
          "浏览 Tokfai model ID、积分消耗、人民币价格示例与可用性。可在 API 请求或 Chat / Image Playground 中使用这些 ID。",
