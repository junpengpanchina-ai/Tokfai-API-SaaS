  ...
  en: {
    ...
    dashboard: {
      ...
      models: {
        ...
        viewPricing: "View pricing",
        viewDocs: "View docs",
        viewIntegrationExample: "View integration example",
        statAvailable: "Available",
        statChat: "Chat / reasoning",
        statImage: "Image",
        beginnerRecommended: "Recommended for beginners",
        recommendedEndpoint: "Recommended endpoint",
        bestFor: "Best for",
      ...
      apiKeys: {
        ...
        securityItem5:
          "If a key is leaked or exposed, Revoke it immediately and create a replacement.",
        apiKeyUnderstandingTitle: "API Key is a universal credential — not bound to a model",
        apiKeyUnderstandingDesc:
          "After you create an API Key, use the same key for every Tokfai model. You do not pick a model when creating a key; you choose the model on each request via the model parameter.",
        apiKeyModelExamplesLabel: "Examples",
        apiKeyAfterCreateHint:
          "After generating a key, open Integration Docs to copy call examples.",
        apiKeyReadyHint:
          "Once the key is created you can call the API. Select the model in the request body model field.",
        viewIntegrationDocs: "Integration docs",
        ...
        createApiKey: "Create API key",
        createApiKeyDesc:
          "Optional name for your reference. Generating a key does not select a model — pick the model in each API request via the model field.",
        keyName: "Key name",
    ...
    admin: {
      ...
      tenants: {
        ...
        createTitle: "New tenant / subsite",
        createDesc:
          "Creates a reseller site with a tokfai.com subdomain. Custom domains can be bound after create.",
        name: "Display name",
        slug: "Slug",
        slugHint: "Maps to {slug}.tokfai.com when the subdomain is active.",
        baseMultiplier: "Base price multiplier",
        tableTitle: "Tenants",
        tableDesc: "Host resolution uses active domains; unknown hosts fall back to Tokfai main.",
        empty: "No tenants yet.",
        save: "Save",
        cnameTarget: "CNAME target",
        domains: "Domains",
        domainsDesc:
          "V1 is manual Cloudflare/DNS. After SSL is ready, mark the domain active.",
        markActive: "Mark active",
        bindDomain: "Bind custom domain",
        modelSettings: "Model enable overrides",
        pricingRules: "Per-model multipliers",
        admins: "Tenant admins",
        addAdmin: "Add admin",
        economics: "Revenue & cost estimate",
        usageRequests: "Usage requests",
        usageCredits: "Credits charged",
        estCost: "Est. cost (credits)",
        paidOrders: "Paid orders",
        estMargin: "Est. margin (credits)",
        users: "Tenant users",
        usage: "Recent usage",
        noUsers: "No attributed users yet.",
        noUsage: "No usage rows yet.",
      },
      docs: {
        title: "Docs registry",
        subtitle:
      ...
      adjust: {
        ...
        subtitle:
          "Grant or deduct compute credits. Amount is credits — not CNY, tokens, or cents.",
      ...
      overview: {
        ...
        riskImageTimeout: "image_task_timeout",
        riskTooManyRequests: "too_many_requests",
        recentImageTasksTitle: "Recent image tasks",
        recentImageTasksDesc: "Latest image generation tasks (status + billing).",
        recentImageTasksEmpty: "No image tasks yet.",
        colBilling: "Billing",
        ...
        colAttemptedModels: "Attempted models",
        colFallbackAttempts: "Fallback attempts",
        colRoutingStrategy: "Routing strategy",
        colFallbackReason: "Fallback reason",
        colLatency: "Latency",
        colTokens: "Tokens",
      ...
      channels: {
        title: "Channels",
        subtitle:
          "Routing channels. Chat/image primary channel is a read-only snapshot; STT upstream channels can be managed here.",
        tableTitle: "Chat / image channels",
        tableDesc: "Configured routing endpoints and weights.",
        readonlyTitle: "Read-only snapshot",
        readonlyBody:
          "Chat/image channel enable/disable and live tests are not available online. Changes require deployment configuration.",
        empty: "No channels configured.",
        statusActive: "Active",
        statusDisabled: "Disabled",
        toggleChannel: "Enable / disable",
        testChannel: "Test connection",
        colChannel: "Channel",
        ...
        sttTitle: "STT upstream channels",
        sttDesc:
          "Internal speech-to-text upstreams. Consumers only use Base URL + API Key + Model — never these credentials.",
        sttEmpty: "No STT channels yet. Create one to route /v1/audio/transcriptions.",
        createStt: "New STT channel",
        edit: "Edit",
        save: "Save",
        cancel: "Cancel",
        created: "STT channel created.",
        saved: "STT channel saved.",
        saveFailed: "Failed to save STT channel.",
        enabledOk: "STT channel enabled.",
        ...
        fieldApiKey: "Upstream API Key",
        fieldDefaultModel: "Default upstream model",
        apiKeyRequired: "Upstream API key is required when creating a channel.",
        baseUrlRequired: "Base URL is required.",
        invalidPriority: "Priority must be a non-negative integer.",
        apiKeyPlaceholder: "Paste upstream key (never a sk-tokfai_* key)",
        apiKeyKeepPlaceholder: "Leave blank to keep the existing key",
        baseUrlKeepPlaceholder: "Leave blank to keep the existing Base URL",
        apiKeyHint:
          "Full key is never shown after save. Leave blank on edit to keep the current secret.",
      },
      pricing: {
        title: "Pricing",
        ...
        modalityImage: "image",
        colInput: "Input (compute credits / 1M tokens)",
        colOutput: "Output (compute credits / 1M tokens)",
        colImage: "Image (compute credits / generation)",
        colStatus: "Status",
        colActions: "Actions",
      },
      logs: {
      ...
      usage: {
        ...
        title: "Currently loaded usage",
        subtitle:
          "Recent request batch (up to 100 rows). Site-wide totals below are server aggregates.",
        ...
        loadedSectionTitle: "Currently loaded batch",
        totalRequests: "Loaded requests",
        succeeded: "Loaded succeeded",
        failed: "Loaded failed",
        imageRequests: "Loaded image",
        chatRequests: "Loaded chat",
        siteSectionTitle: "Site-wide totals",
        siteTotalRequests: "Total requests",
        siteSucceeded: "Succeeded",
        siteFailed: "Failed",
        siteImageRequests: "Image requests",
        siteChatRequests: "Chat requests",
        siteCreditsCharged: "Credits charged (all time)",
        filtersTitle: "Filters",
        filtersDesc:
  ...
  zh: {
    ...
    dashboard: {
      ...
      models: {
        ...
        viewPricing: "查看定价",
        viewDocs: "查看接入文档",
        viewIntegrationExample: "查看接入示例",
        statAvailable: "可用模型",
        statChat: "对话 / 推理",
        statImage: "图片",
        beginnerRecommended: "新手推荐",
        recommendedEndpoint: "推荐 Endpoint",
        bestFor: "适合场景",
        imageInput: "图片输入",
        ownedBy: "归属",
        routesTo: "路由到",
      ...
      apiKeys: {
        ...
        apiKeyUnderstandingTitle: "API Key 是通用密钥，不绑定模型",
        apiKeyUnderstandingDesc:
          "创建 API Key 后，你可以用同一个 Key 调用 Tokfai 支持的所有模型。模型不在创建 Key 时选择，而是在每次请求的 model 参数里选择。",
        apiKeyModelExamplesLabel: "示例",
        apiKeyAfterCreateHint: "生成 Key 后，请到「接入文档」复制调用示例。",
        apiKeyReadyHint:
          "生成 Key 后即可调用；模型在 API 请求参数里选择。",
        viewIntegrationDocs: "接入文档",
        ...
        safeRetryNote: "最多 3 次退避重试——不要对 429 / 503 / 504 无限重试。",
        trafficGovernorTitle: "流量治理与 Worker",
        trafficGovernorNote: "队列 + 并发限制——复制 Chat / Image / Batch Worker。",
        ...
        planIntegrationNote: "选择行业与在线人数——获得并发、模型与 Worker 模板。",
        planMyIntegration: "规划接入",
        capacityPlannerLink: "容量规划",
        scaleSafelyLink: "安全扩容",
        copyIntegrationPlan: "复制接入方案",
        planHandoffPack: "方案交接包",
        copyGoLiveAcceptance: "复制上线验收",
        ...
        createApiKeyDesc: "可选名称，便于区分。生成 Key 不会选择模型——请在每次请求的 model 字段中填写模型 ID。",
        keyName: "密钥名称",
    ...
    admin: {
      ...
      tenants: {
        ...
        createTitle: "新建分站",
        createDesc:
          "创建代理分站并自动绑定 tokfai.com 子域名。自定义域名可在创建后绑定。",
        name: "显示名称",
        slug: "Slug",
        slugHint: "激活后映射为 {slug}.tokfai.com。",
        baseMultiplier: "基础价格倍率",
        tableTitle: "分站列表",
        tableDesc: "Host 通过已激活域名识别；未命中时回落 Tokfai 主站。",
        empty: "暂无分站。",
        save: "保存",
        cnameTarget: "CNAME 目标",
        domains: "域名",
        domainsDesc:
          "V1 仅支持手工配置 Cloudflare/DNS。SSL 就绪后在后台标记 active。",
        markActive: "标记为 active",
        bindDomain: "绑定自定义域名",
        modelSettings: "模型开关覆盖",
        pricingRules: "单模型倍率",
        admins: "分站管理员",
        addAdmin: "添加管理员",
        economics: "收入与成本估算",
      ...
      overview: {
        ...
        riskImageTimeout: "image_task_timeout",
        riskTooManyRequests: "too_many_requests",
        recentImageTasksTitle: "最近图片任务",
        recentImageTasksDesc: "最近图片生成任务（状态 + 计费）。",
        recentImageTasksEmpty: "暂无图片任务。",
        colBilling: "计费",
      ...
      channels: {
        title: "渠道",
        subtitle:
          "路由渠道。Chat/Image 主渠道为只读快照；STT 上游渠道可在此管理。",
        tableTitle: "Chat / Image 渠道",
        tableDesc: "已配置的路由端点与权重。",
        readonlyTitle: "只读快照",
        readonlyBody:
          "Chat/Image 渠道启停与在线测试暂不支持。如需变更，请走部署配置后重新发布。",
        empty: "暂无渠道配置。",
        statusActive: "启用",
        statusDisabled: "禁用",
        toggleChannel: "启用 / 禁用",
        ...
        sttTitle: "STT 上游渠道",
        sttDesc:
          "内部语音转写上游。消费者只使用 Base URL + API Key + Model，不会接触这些凭证。",
        sttEmpty: "暂无 STT 渠道。创建后可路由 /v1/audio/transcriptions。",
        createStt: "新建 STT 渠道",
        edit: "编辑",
        save: "保存",
        cancel: "取消",
        ...
        fieldApiKey: "上游 API Key",
        fieldDefaultModel: "默认上游模型",
        apiKeyRequired: "创建渠道时必须填写上游 API Key。",
        baseUrlRequired: "Base URL 必填。",
        invalidPriority: "优先级必须为非负整数。",
        apiKeyPlaceholder: "粘贴上游密钥（不要填入 sk-tokfai_*）",
        apiKeyKeepPlaceholder: "留空则保留现有密钥",
        baseUrlKeepPlaceholder: "留空则保留现有 Base URL",
        apiKeyHint: "保存后不会回显完整密钥。编辑时留空表示不替换。",
      },
      pricing: {
        title: "定价",
      ...
      usage: {
        ...
        title: "当前加载用量",
        subtitle:
          "最近请求批次（最多 100 条）。下方全站汇总为服务端真实统计。",
        couldNotLoad: "无法加载用量日志",
        loadFailed: "加载用量日志失败。",
        loadErrorGeneric: "用量日志暂时无法加载。",
        loadedSectionTitle: "当前加载批次",
        totalRequests: "当前加载请求",
        succeeded: "当前加载成功",
        failed: "当前加载失败",
        imageRequests: "当前加载图像",
        chatRequests: "当前加载对话",
        siteSectionTitle: "全站汇总",
        siteTotalRequests: "全站总请求",
        siteSucceeded: "全站成功",
        siteFailed: "全站失败",
        siteImageRequests: "全站图像请求",
        siteChatRequests: "全站对话请求",
        siteCreditsCharged: "全站累计消耗积分",
        filtersTitle: "筛选",
