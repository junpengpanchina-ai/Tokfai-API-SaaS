...
export const messages = {
  en: {
    ...
    pricing: {
      ...
      colTags: "Tags",
      imageModelsIntro:
        "Image generation is billed per successful generation in credits. Each model uses a different amount; failed requests are not charged.",
    ...
    docs: {
      ...
      imageBillingDesc:
        "Image models are billed per successful generation in credits. Display shows credits per generation. Actual credits charged per request appear in Usage.",
      imageApiBilling:
        "Image models are billed per successful generation in credits. Each model uses a different credit amount. Failed requests are not charged.",
  ...
  zh: {
    ...
    pricing: {
      ...
      colTags: "Tags",
      imageModelsIntro:
        "图片生成按每次成功生成扣除积分，不同模型消耗不同；失败请求不扣费。",
    ...
    docs: {
      ...
      imageBillingDesc:
        "图像模型按每次成功生成扣除积分。展示为每次生成的积分价格。每次请求实际扣除积分见 Usage。",
      imageApiBilling:
        "图像模型按每次成功生成扣除积分，不同 model 消耗不同；失败请求不扣费。",
