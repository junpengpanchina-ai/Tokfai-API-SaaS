  ...
  en: {
    ...
    admin: {
      ...
      rechargePlans: {
        ...
        subtitle:
          "Edit Starter / Pro / Business packages. Final credits are computed as base + bonus on the server.",
        ...
        amountInvalid: "Enter a valid price in yuan (0 or greater).",
        yes: "Yes",
        no: "No",
        colId: "ID",
        colName: "Name",
  ...
  zh: {
    ...
    admin: {
      ...
      rechargePlans: {
        title: "充值套餐",
        subtitle:
          "编辑 Starter / Pro / Business。到账积分由服务端按「基础 + 赠送」自动计算。",
        tableTitle: "套餐列表",
