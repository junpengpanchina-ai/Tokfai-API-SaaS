...
const EN: Record<string, string> = {
  ...
  "dashboard.imagePlayground.generateFromReference": "Generate from reference",
  "dashboard.imagePlayground.referenceImageRequired": "Please upload a reference image first. This kind of request needs an original photo — after you upload one, I will keep the subject and only change what you specify.",
  "dashboard.imagePlayground.referenceEditResultTitle": "Reference edit result",
  "dashboard.imagePlayground.subjectDriftHint": "If the subject changed too much, click Strengthen subject preserve and retry.",
  ...
  "dashboard.imagePlayground.modeReferenceHint": "Upload a reference photo, then describe only what to change. Subject consistency is best-effort.",
  ...
  "dashboard.imagePlayground.subjectPreserveHonesty": "Current flow is reference-assisted generation — the subject may still change. Use for drafts, not ID-photo / real-person outfit delivery.",
  "dashboard.imagePlayground.referenceEditResultHint": "Generated with your reference image attached. Subject preserve is best-effort and may still drift.",
  "dashboard.imagePlayground.errors.blobUrlBlocked": "Browser blob URLs cannot be sent to the API. Please re-upload the image file.",
  "dashboard.imagePlayground.errors.referenceImageUnreadable": "参考图没有成功读取，请重新上传图片后再试。",
  "dashboard.imagePlayground.errors.referenceImageMissing": "需要上传参考图后才能进行保留主体改图。",
  "dashboard.imagePlayground.errors.modelNotForSubjectPreserve": "当前模型更适合生成新图，不适合强保留人物主体。请切换到支持参考图改图的模型。",
...
const ZH: Record<string, string> = {
  ...
  "dashboard.imagePlayground.generateFromReference": "基于参考图生成",
  "dashboard.imagePlayground.referenceImageRequired": "请先上传一张参考图。这类需求需要基于原图改图，上传后我会尽量保留人物主体，只修改你指定的部分。",
  "dashboard.imagePlayground.referenceEditResultTitle": "参考图改图结果",
  "dashboard.imagePlayground.referenceEditResultHint": "已附带参考图生成。人物主体保留为尽力而为，仍可能漂移。",
  "dashboard.imagePlayground.subjectDriftHint": "如果人物主体变化明显，可以点击「加强保留主体再试」。",
  ...
  "dashboard.imagePlayground.modeReferenceHint": "先上传参考图，再只描述要改的部分。人物一致性为尽力而为。",
  "dashboard.imagePlayground.fastModelEditHint": "快速模型更适合草稿。需要人物一致时，请优先选择标准 / Pro 模型。",
  "dashboard.imagePlayground.subjectPreserveHonesty": "当前为参考图辅助生成，人物主体可能变化。建议用于草图，不建议用于证件照/真人换装交付。",
  "dashboard.imagePlayground.errors.blobUrlBlocked": "无法把浏览器本地 blob 地址发给 API，请重新上传图片文件。",
  "dashboard.imagePlayground.errors.referenceImageUnreadable": "参考图没有成功读取，请重新上传图片后再试。",
  "dashboard.imagePlayground.errors.referenceImageMissing": "需要上传参考图后才能进行保留主体改图。",
  "dashboard.imagePlayground.errors.modelNotForSubjectPreserve": "当前模型更适合生成新图，不适合强保留人物主体。请切换到支持参考图改图的模型。",
