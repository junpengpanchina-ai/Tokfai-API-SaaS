...
const EN: Record<string, string> = {
  ...
  "dashboard.imageWorkbench.subtitle": "Upload a product or ecommerce image as input. Understand it, generate copy, or generate/edit images — three separate actions.",
  "dashboard.imageWorkbench.tabAnalysis": "Understand image",
  "dashboard.imageWorkbench.tabCopy": "Generate copy",
  "dashboard.imageWorkbench.tabGenerate": "Generate / edit image",
  "dashboard.imageWorkbench.analysisTitle": "Understand image",
  "dashboard.imageWorkbench.analysisDesc": "Upload a product, person, or ecommerce image to identify content, selling points, and fit scenarios.",
  "dashboard.imageWorkbench.copyTitle": "Generate copy",
  ...
  "dashboard.imageWorkbench.startAnalyze": "Understand",
  "dashboard.imageWorkbench.startCopy": "Generate copy",
  "dashboard.imageWorkbench.analyzing": "Understanding…",
  ...
  "dashboard.imageWorkbench.tabAnalysisDesc": "Upload a product, person, or ecommerce image to identify content, selling points, and fit scenarios.",
  "dashboard.imageWorkbench.tabCopyDesc": "Based on the uploaded image and your needs, directly generate titles, selling points, seeding copy, ads, and detail-page copy.",
  "dashboard.imageWorkbench.tabGenerateDesc": "Text-to-image, reference edit, background/style changes — visual generation only.",
  ...
  "dashboard.imageWorkbench.analysisResultEmpty": "Upload an image and click Understand to see results here.",
  ...
  "dashboard.imageWorkbench.timeoutFriendly": "This took longer than expected and did not finish. Try again later, or shorten your notes and retry.",
...
const ZH: Record<string, string> = {
  ...
  "dashboard.imageWorkbench.subtitle": "上传商品图或电商素材作为输入：看懂图片、生成文案、生成/改图是三个独立动作。",
  "dashboard.imageWorkbench.tabAnalysis": "看懂图片",
  "dashboard.imageWorkbench.tabCopy": "生成文案",
  "dashboard.imageWorkbench.tabGenerate": "生成/改图",
  "dashboard.imageWorkbench.analysisTitle": "看懂图片",
  "dashboard.imageWorkbench.analysisDesc": "上传商品图、人物图或电商素材，先识别图片内容、商品卖点和适用场景。",
  "dashboard.imageWorkbench.copyTitle": "生成文案",
  "dashboard.imageWorkbench.copyDesc": "基于上传图片和你的需求，直接生成标题、卖点、种草文案、广告文案、详情页文案。",
  ...
  "dashboard.imageWorkbench.tabAnalysisDesc": "上传商品图、人物图或电商素材，先识别图片内容、商品卖点和适用场景。",
  "dashboard.imageWorkbench.tabCopyDesc": "基于上传图片和你的需求，直接生成标题、卖点、种草文案、广告文案、详情页文案。",
  "dashboard.imageWorkbench.tabGenerateDesc": "用于文生图、参考图改图、换背景、换风格等视觉生成。",
  ...
  "dashboard.imageWorkbench.analysisResultEmpty": "上传图片并点击看懂图片，结果会显示在这里。",
  ...
  "dashboard.imageWorkbench.timeoutFriendly": "生成时间较长，本次没有完成。可以稍后重试，或减少需求描述后再试。",
