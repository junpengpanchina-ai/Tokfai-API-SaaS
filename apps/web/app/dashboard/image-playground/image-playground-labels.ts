...
const EN: Record<string, string> = {
  ...
  "dashboard.imagePlayground.referenceEditResultHint": "Generated from your reference image. The system tries to keep the subject and only change what you asked.",
...
const ZH: Record<string, string> = {
  ...
  "dashboard.imagePlayground.referenceEditResultHint": "已基于参考图生成，系统会尽量保留主体，只修改你指定的部分。",
