...
import { isStarterTemplatesKeyPlaceholder } from "./starter-templates-display-helpers";
...
export function StarterTemplateConfiguratorClient({
  apiKey,
  copiedId,
  onCopy,
  ...
  const keyIsPlaceholder = isStarterTemplatesKeyPlaceholder(apiKey);
