-- P7.23: Stripe Checkout webhook idempotency by stripe_checkout_session_id.
-- Handles concurrent duplicate webhooks via unique_violation on credit_ledger insert.
