...
3. The gate must run typecheck, build, LIVE p932/p933/p941/p942/p946,
 p948 (mock/static Nano Banana capability; real upstream only with
 `LIVE=1 MODEL=nano-banana`), and `public-beta-ready-all`.
